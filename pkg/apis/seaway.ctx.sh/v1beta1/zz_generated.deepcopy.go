...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EnvironmentStore) DeepCopyInto(out *EnvironmentStore) {
	*out = *in
	if in.Bucket != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EnvironmentStore.
func (in *EnvironmentStore) DeepCopy() *EnvironmentStore {
	if in == nil {
		return nil
	}
	out := new(EnvironmentStore)
